                ...
                listOf(
                    SystemCoreConfig(
                        ...
                        defaultSettings = listOf(
                            ...
                            CoreVariable("duckstation_Display.ActiveStartOffset", "0"),
                            CoreVariable("duckstation_Display.AspectRatio", "4:3"),
                            CoreVariable("duckstation_Display.CropMode", "Borders"),
                            CoreVariable("duckstation_Display.CustomAspectRatioDenominator", "3"),
                            CoreVariable("duckstation_Display.CustomAspectRatioNumerator", "4"),
                            CoreVariable("duckstation_Display.Force4_3For24Bit", "false"),
                            CoreVariable("duckstation_Display.LineEndOffset", "0"),
                            CoreVariable("duckstation_Display.LineStartOffset", "0"),
                            CoreVariable("duckstation_Display.ShowOSDMessages", "true"),
                            CoreVariable("duckstation_GPU.Renderer", "OpenGL"),
                        ),
                        rumbleSupported = true,
